...
AmCharts.formatDuration = function(a, b, d, e, f, g) {
	...
	if (h[f].count > h[b].count)
		for (a = h[b].count; a < h[f].count; a++) b = h[b].nextInterval, "ss" == b || "mm" == b || "hh" == b ? d = "00" + e[b] + "" + d : "DD" == b && (d = "0" + e[b] + "" + d);
	...
	if (a) {
		...
		if (0 != b)
			if ("[object Array]" === Object.prototype.toString.call(a))
				for (var d = 0; d < a.length; d++) AmCharts.deleteObject(a[d], b - 1), a[d] = null;
			else try {
...
AmCharts.Cuboid = AmCharts.Class({
	...
	draw: function() {
		...
		if (0 < f || 0 < g) x = r, r = AmCharts.adjustLuminosity(p, -0.2), r = AmCharts.adjustLuminosity(p, -0.2), q = AmCharts.polygon(b, [0, f, d + f, d, 0], [0, g, g, 0, 0], r, j, 0, 0, 0, n), 0 < m && (C = AmCharts.line(b, [0, f, d + f], [0, g, g], l, m, k)), u = AmCharts.polygon(b, [0, 0, d, d, 0], [0, e, e, 0, 0], r, j, 0, 0, 0, 0, n), u.translate(f, g), 0 < m && (t = AmCharts.line(b, [f, f], [g, g + e], l, 1, k)), v = AmCharts.polygon(b, [0, 0, f, f, 0], [0, e, e + g, g, 0], r, j, 0, 0, 0, n), w = AmCharts.polygon(b, [d, d, d + f, d + f, d], [0, e, e + g, g, 0], r, j, 0, 0, 0, n), 0 < m && (y = AmCharts.line(b, [d, d + f, d + f, d], [0, g, e + g, e], l, m, k)), r = AmCharts.adjustLuminosity(x, 0.2), x = AmCharts.polygon(b, [0, f, d + f, d, 0], [e, e + g, e + g, e, e], r, j, 0, 0, 0, n), 0 < m && (z = AmCharts.line(b, [0, f, d + f], [e, e + g, e + g], l, m, k));
		1 > Math.abs(e) && (e = 0);
		1 > Math.abs(d) && (d = 0);
...
AmCharts.AmLegend = AmCharts.Class({
	...
	arrangeEntries: function() {
		...
		for (v = 0; v < u.length; v++) {
			...
			C + t.width > n && 0 < v && (w++, y = 0, C = g, x = C + t.width +
				g + m);
			z.translate(C, (p + l) * w);
			y++;
			!isNaN(k) && y >= k && (y = 0, w++);
...
AmCharts.AmBalloon = AmCharts.Class({
	...
	setPosition: function(a, b, d) {
		this.pointToX = a;
		this.pointToY = b;
		d && (a != this.previousX || b != this.previousY) &&
			this.draw();
		this.previousX = a;
		this.previousY = b
	},
	...
	parseSerialData: function() {
		...
		if (f) {
			...
			for (m = 0; m < f.length; m++) {
				...
				h && (n.forceShow = s[h]);
				l[s[e]] = n;
				g && (b = isNaN(b) ? new Date(b.getFullYear(), b.getMonth(), b.getDate(), b.getHours(), b.getMinutes(), b.getSeconds(),
					b.getMilliseconds()) : new Date(b), b = AmCharts.resetDateToMin(b, k, j), n.category = b, n.time = b.getTime());
...
AmCharts.AmSerialChart = AmCharts.Class({
	...
	countColumns: function() {
		...
		for (j = 0; j < b; j++) {
			...
			if ("none" ==
				k || "3d" == k)
				for (h = 0; h < d; h++) e = this.graphs[h], !e.hidden && (e.valueAxis == f && "column" == e.type) && (e.columnIndex = a, a++);
			if ("3d" == k) {
...
AmCharts.ValueAxis = AmCharts.Class({
		...
		if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
			...
			if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs && Infinity != this.min && -Infinity !=
				...
				var l = this.labelFrequency,
					...
					q;
				!0 === j ? (q = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / q, 2 < q && (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, p = Math.round(Math.log(this.minReal) * Math.LOG10E), r > this.gridCount && (s = Math.ceil(r / this.gridCount)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
				d = 0;
				...
				if (0 < w) {
					...
					for (e = this.fillAlpha = 0; e < w; e++) {
						var x = v[e],
							...
							C = x.above;
						isNaN(x.toValue) ||
							(z = this.getCoordinate(x.toValue), t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, x), this.pushAxisItem(t, C));
						var I = NaN;
				...
				v = !1;
				for (e = p; e < r; e += s) t = AmCharts.roundTo(this.step * e + this.min, d), -1 != String(t).indexOf("e") &&
					(v = !0, String(t).split("e"));
				this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
				for (e = p; e < r; e += s)
					if (p = this.step * e + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !(this.integersOnly && Math.round(p) != p)) {
						!0 === j && (0 === p && (p = this.minReal), 2 < q && (p = Math.pow(10, e)), v = -1 != String(p).indexOf("e") ? !0 : !1);
	...
	stackGraphs: function(a) {
		...
		for (k = this.start; k <= this.end; k++) {
			...
			for (n = 0; n < j.length; n++)
				if (m = j[n], !m.hidden && (l = m.type, m.chart == this.chart && (m.valueAxis == this && a == l && m.stackable) && (l = this.data[k].axes[this.id].graphs[m.id], h = l.values.value, !isNaN(h)))) {
	...
	getMinMax: function() {
		...
		if (this.includeGuidesInMinMax &&
			0 < a)
			for (b = 0; b < a; b++) d = this.guides[b], d.toValue < this.min && (this.min = d.toValue), d.value < this.min && (this.min = d.value), d.toValue > this.max && (this.max = d.toValue), d.value > this.max && (this.max = d.value);
				...
				if (f.hasOwnProperty(g)) {
					...
					if (h.includeInMinMax && (!h.hidden || this.includeHidden)) {
						...
						if (this.minMaxField) j = h[this.minMaxField], j < d && (d =
							...
							for (var k in h) h.hasOwnProperty(k) && ("percents" != k && "total" != k) && (j = h[k], j < d && (d = j))
					}
				}
		}
		return d
...
AmCharts.CategoryAxis = AmCharts.Class({
	...
	draw: function() {
		...
		if (AmCharts.ifArray(a)) {
			...
			if (this.parseDates && !this.equalSpacing) {
				...
				if (this.parseDates && this.equalSpacing) {
					...
					for (this.end - this.start > this.gridCount && (u = !0); b < p; b++)
						if (r = this.data[b].time, this.checkPeriodChange(f, n, r, m)) {
							...
							m = AmCharts.formatDate(new Date(r), m);
							if (b == e && !j || b == h && !k) m = " ";
							u ? u = !1 : (t || (v = !1), l = new this.axisItemRenderer(this, l, m, void 0, void 0, void 0,
								void 0, v), l.graphics(), this.pushAxisItem(l));
							m = r
						}
				}
				...
				b / 2 == Math.round(b / 2) && b--;
				0 > b && (b = 0);
				for (h = 0; b <= this.end + 2; b++)
					if (0 <= b && b < this.data.length ? (s = this.data[b], m = s.category) : m = "", b / t == Math.round(b / t) || s.forceShow) {
			...
			for (b = 0; b < this.data.length; b++)
				if (j = this.data[b]) k = this.parseDates && !this.equalSpacing ? Math.round((j.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - g), j.x[this.id] = k;
			j = this.guides.length;
			for (b = 0; b < j; b++) k = this.guides[b], p = p = p = h = t = NaN, e = k.above, k.toCategory && (p = d.getCategoryIndexByValue(k.toCategory), isNaN(p) || (t = this.getCoordinate(p - g), l = new this.axisItemRenderer(this,
	...
	categoryToCoordinate: function(a) {
		return this.chart ? (a = this.chart.getCategoryIndexByValue(a), this.getCoordinate(a -
			this.start)) : NaN
	},
	...
	construct: function(a, b, d, e, f, g, h, j, k) {
		...
		if ("H" == ea) {
			if (0 <= b && b <= ca + 1 && (0 < t && (0 < u && b + k <= ca + 1) && (ma = AmCharts.line(s, [b + k, b + k], [0, t], q, u, w), p.push(ma)), 0 < v && (W = AmCharts.line(s, [b, b + U, b + U], [fa, fa + T, T], y, v, w, x), p.push(W))), E = 0, F = b, h && 90 == G && (F -= m), !1 === e ? (W = "start", E = "bottom" == N ? R ? E + t : E - t : R ? E - t : E + t, F += 3, f && (F += f / 2, W = "middle"), 0 < G && (W = "middle")) : W = "middle", 1 == O && (0 < C && !h && V < ca) && (e = AmCharts.fitToBounds(b, 0, ca), V = AmCharts.fitToBounds(V, 0, ca), aa = e - V, 0 < aa && (fill = AmCharts.rect(s, aa, a.height, z, C), fill.translate(e - aa + U, T),
					p.push(fill))), "bottom" == N ? (E += fa + m / 2 + da, R ? 0 < G ? (E = fa - ga / 2 * Math.sin(P) - t - 3, F += ga / 2 * Math.cos(P)) : E -= t + m + 3 + 3 : 0 < G ? (E = fa + ga / 2 * Math.sin(P) + t + 3, F -= ga / 2 * Math.cos(P)) : E += t + r + 3 + 3) : (E += T + m / 2 - da, F += U, R ? 0 < G ? (E = ga / 2 * Math.sin(P) + t + 3, F -= ga / 2 * Math.cos(P)) : E += t + 3 : 0 < G ? (E = -(ga / 2) * Math.sin(P) - t - 6, F += ga / 2 * Math.cos(P)) : E -= t + m + 3 + r + 3), "bottom" == N ? aa = (R ? fa - t - 1 : fa + r - 1) + da : (A = U, aa = (R ? T : T - t - r + 1) - da), g && (F += g), T = F, 0 < G && (T += ga / 2 * Math.cos(P)), X && (N = 0, R && (N = ga / 2 * Math.cos(P)), T + N > ca + 1 || 0 > T)) X.remove(), X = null
		} else {
			0 <= b && b <= fa + 1 && (0 <
				t && (0 < u && b + k <= fa + 1) && (ma = AmCharts.line(s, [0, t], [b + k, b + k], q, u, w), p.push(ma)), 0 < v && (W = AmCharts.line(s, [0, U, ca + U], [b, b + T, b + T], y, v, w, x), p.push(W)));
			W = "end";
			...
			E += m / 2;
			"right" == N ? (F += U + ca + da, E += T, R ? (F -= t + 4, g || (E -= m / 2 + 3)) : (F += t + 4 + r, E -= 2)) : R ? (F += t + 4 - da, g || (E -= m / 2 + 3), h &&
				(F += U, E += T)) : (F += -t - r - 4 - 2 - da, E -= 2);
			ma && ("right" == N ? (A += U + da + ca, aa += T, A = R ? A - r : A + r) : (A -= da, R || (A -= t + r)));
			g && (E += g);
			R = -3;
			"right" == N && (R += T);
			if (X && (E > fa + 1 || E < R)) X.remove(), X = null
		}
...
AmCharts.RadItem = AmCharts.Class({
	construct: function(a, b, d, e, f, g, h) {
		...
		h ? (y = !0, isNaN(h.tickLength) ||
			(p = h.tickLength), void 0 != h.lineColor && (u = h.lineColor), isNaN(h.lineAlpha) || (r = h.lineAlpha), isNaN(h.dashLength) || (t = h.dashLength), isNaN(h.lineThickness) || (q = h.lineThickness), !0 === h.inside && (x = !0)) : d || (r /= 3, p /= 2);
		var O = "end",
			R = -1;
		x && (O = "start", R = 1);
		var U;
...
AmCharts.AmGraph = AmCharts.Class({
	...
	draw: function() {
		...
		AmCharts.ifArray(this.data) &&
			(d = !1, "xy" == this.chartType ? this.xAxis.axisCreated && this.yAxis.axisCreated && (d = !0) : this.valueAxis.axisCreated && (d = !0), !this.hidden && d && this.createGraph())
	},
	...
	createSerialGraph: function() {
		...
		f.logarithmic &&
			(Qa = f.getCoordinate(f.minReal));
		this.minCoord = Qa;
		this.resetBullet && (this.bullet = "none");
		if (!O && ("line" == g || "smoothedLine" == g || "step" == g))
			if (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet = "round", this.resetBullet = !0), Fa || void 0 != ya) {
				var Aa = T;
				Aa > f.max && (Aa = f.max);
				Aa < f.min && (Aa = f.min);
				...
				m ? (X = k, Ya = Math.abs(nb - ta), $a = k, ab = Math.abs(Qa - ta), Pa = Za = 0, f.reversed ? (Na = 0, Oa = ta) : (Na = ta, Oa = 0)) : (Ya = j, X = Math.abs(nb - ta), ab =
					j, $a = Math.abs(Qa - ta), Oa = Na = 0, f.reversed ? (Pa = l, Za = ta) : Pa = ta + 1)
			}
		var ua = Math.round;
		this.pmx = ua(Na);
		this.pmy = ua(Za);
		...
		if ("line" == g || "step" == g || "smoothedLine" == g) {
			if (0 < I)
				for (L = I - 1; - 1 < L; L--)
					if (E = d[L], A = E.axes[f.id].graphs[a], ga = A.values.value) {
						I = L;
						break
					}
			if (G < d.length - 1)
		...
		var ha = [],
			...
			Ia = !1;
		if ("line" == g || "step" == g || "smoothedLine" == g)
			if (this.stackable && "regular" == z || "100%" == z || this.fillToGraph) Ia = !0;
		for (L = I; L <= G; L++) {
			E = d[L];
			...
			var sa = A.values;
			f.recalculateToPercents && (sa =
				A.percents);
			if (sa) {
				S = !this.stackable || "none" == z || "3d" == z ? sa.value : sa.close;
				if ("candlestick" == g || "ohlc" == g) S = sa.close, Ua = sa.low, Ba = f.getCoordinate(Ua), Ta = sa.high, Ca = f.getCoordinate(Ta);
				ja = sa.open;
				B = f.getCoordinate(S);
				...
				switch (g) {
					case "line":
						...
						break;
					case "smoothedLine":
						isNaN(S) ? p || (this.drawSmoothedGraph(r, q, ha, ia), r = [], q = [], ha = [], ia = []) : (A.isNegative = S < T ? !0 : !1, r.push(D), q.push(B), Y = D, ba = B, pa = D, qa = B, Ia && (!isNaN(M) &&
							!isNaN(Q)) && (ha.push(Q), ia.push(M)));
						break;
					case "step":
						isNaN(S) ? p || (t = NaN, this.drawLineGraph(r, q, ha, ia), r = [], q = [], ha = [], ia = []) : (A.isNegative = S < T ? !0 : !1, m ? (isNaN(u) || (r.push(u), q.push(B - wa)), q.push(B - wa), r.push(D), q.push(B + Ka), r.push(D), Ia && (!isNaN(M) && !isNaN(Q)) && (ha.push(Q), ia.push(M - wa), ha.push(Q), ia.push(M + Ka))) : (isNaN(t) || (q.push(t), r.push(D - wa)), r.push(D - wa), q.push(B), r.push(D + Ka), q.push(B), Ia && (!isNaN(M) && !isNaN(Q)) && (ha.push(Q - wa), ia.push(M), ha.push(Q + Ka), ia.push(M))), u = D, t = B, Y = D, ba = B, pa = D,
							qa = B);
						break;
					case "column":
						la = na;
						...
						if (!isNaN(S)) {
							...
							if (!(S < ob && ja < ob || S > pb && ja > pb))
								if (m) {
									...
									if (K < k && 0 < H && (ka = new AmCharts.Cuboid(e, Z, H, y, x, va, Ja, N, la, V, W, s,
											m), "bottom" != C))
										if (C = f.reversed ? "left" : "right", 0 > S) C = f.reversed ? "right" : "left";
									...
									if (J < j + ea * y && 0 < H)
										if (ka = new AmCharts.Cuboid(e, H, Z, y, x, va, Ja, N, la, this.lineAlpha, W, s, m), 0 > S && "middle" != C) C = "bottom";
										else if (C = ma, "regular" ==
										z || "100%" == z) ba += this.dy
								}
							if (ka && (ra = ka.set, ra.translate(J, K), this.columnsSet.push(ra), A.url && ra.setAttr("cursor", "pointer"), !O)) {
								...
								if ("regular" == z || "100%" == z) C = "middle", w = m ? 0 < sa.value ? (this.end + 1 - L) * v + b : (this.end + 1 - L) * v - b : 0 < sa.value ? v * L + b : v * L - b;
					...
					case "candlestick":
						if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(S)) {
							...
							ka && (ra = ka.set, da.push(ra), ra.translate(J, K), A.url && ra.setAttr("cursor", "pointer"), Va && (da.push(Va), da.push(bb)), Y = D, ba = B, pa = D, qa = B, O || (A.x = m ? K + H / 2 : J + H / 2, this.animateColumns(ka,
								L, D, Q, B, M), this.addListeners(ra, A)))
						}
						break;
					case "ohlc":
						if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(S)) {
					...
					if (this.end - this.start <= sb || 0 === sb) {
						...
						if (tb) {
							...
							if ($) {
								if (!isNaN(ba) &&
									!isNaN(Y))
									if (Y += xa, ba += za, $.translate(Y, ba), m) {
										if (0 > ba || ba > k) $.remove(), $ = null
									} else {
										var vb = 0;
										"3d" == z && (vb = y * ea);
										if (0 > Y || Y > j + vb) $.remove(), $ = null
									}
								else $.remove(), $ = null;
		...
		if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(r, q, ha, ia) : this.drawLineGraph(r, q, ha, ia), O || this.launchAnimation()
	},
	...
	drawLineGraph: function(a, b, d, e) {
		if (1 < a.length) {
			...
			if (0 < f && (k = a.join(";").split(";"), l = b.join(";").split(";"), "serial" == this.chartType && (0 < d.length ? (d.reverse(), e.reverse(), k = a.concat(d), l = b.concat(e)) :
					this.rotate ? (l.push(l[l.length - 1]), k.push(q), l.push(l[0]), k.push(q), l.push(l[0]), k.push(k[0])) : (k.push(k[k.length - 1]), l.push(q), k.push(k[0]), l.push(q), k.push(a[0]), l.push(l[0]))), a = AmCharts.polygon(g, k, l, n, f, 0, 0, 0, this.gradientRotation), h.push(a), p || void 0 !== s)) isNaN(r) && (r = f), p || (p = s), g = AmCharts.polygon(g, k, l, p, r, 0, 0, 0, this.gradientRotation), j.push(g);
			this.applyMask(j, h)
		}
	},
	...
	drawSmoothedGraph: function(a, b, d, e) {
		if (1 < a.length) {
			...
			if (0 < m && (l = a.join(";").split(";"), u = b.join(";").split(";"),
					k = "", 0 < d.length ? (d.reverse(), e.reverse(), l = a.concat(d), u = b.concat(e)) : (this.rotate ? (k += " L" + q + "," + b[b.length - 1], k += " L" + q + "," + b[0]) : (k += " L" + a[a.length - 1] + "," + q, k += " L" + a[0] + "," + q), k += " L" + a[0] + "," + b[0]), d = new AmCharts.Bezier(g, l, u, NaN, 0, 0, n, m, f, k), h.push(d.path), p || void 0 !== s)) r || (r = m), p || (p = s), a = new AmCharts.Bezier(g, a, b, NaN, 0, 0, p, r, f, k), j.push(a.path);
			this.applyMask(j, h)
		}
	},
	...
	legendKeyAlpha: function() {
		...
		void 0 === a && (a = this.lineAlpha,
			0 === a && this.fillAlphas && (a = this.fillAlphas), 0 === a && (a = this.bulletAlpha), 0 === a && (a = 1));
		return a
	},
	createBullet: function(a, b, d) {
		...
		if ("none" != this.bullet || a.bullet) {
			...
			switch (f) {
				...
				case "triangleLeft":
					j =
						AmCharts.triangle(e, g, 270, n, s, h, l, m);
					break;
				case "triangleRight":
		...
		if (this.customBullet || a.customBullet) l = this.customBullet, a.customBullet && (l = a.customBullet), l && (j && j.remove(), "function" == typeof l ? (j = new l, j.chart = this.chart, a.bulletConfig && (j.availableSpace = d, j.graph = this, a.bulletConfig.minCoord = this.minCoord - d, j.bulletConfig = a.bulletConfig), j.write(e), j = j.set) : (this.chart.path && (l = this.chart.path +
			l), j = e.image(l, 0, 0, g, g), this.centerCustomBullets && (b -= g / 2, d -= g / 2, f -= g / 2, h -= g / 2)));
		if (j) {
			a.url && j.setAttr("cursor", "pointer");
			if ("serial" == this.chartType && (b - f < k || b - f > this.width || d < -g / 2 || d - h > this.height)) j.remove(), j = null;
...
AmCharts.ChartCursor = AmCharts.Class({
	...
	draw: function() {
		...
		if (a.valueBalloonsEnabled)
			for (d = 0; d < b.graphs.length; d++) e = new AmCharts.AmBalloon, e.chart = b, AmCharts.copyProperties(b.balloon, e), b.graphs[d].valueBalloon = e;
	...
	createCursor: function() {
		...
		this.set.push(b);
		a ? (f && (h.pointerWidth = 0), "right" == e ? f ? h.setBounds(n, s + m, n + p + l, s + r + m) : h.setBounds(n + p + l + g, s + m, n + p + 1E3, s + r + m) : f ? h.setBounds(n, s, p + n, r + s) : h.setBounds(-1E3, -1E3, n - q - g, s + r + 15)) : (h.maxWidth = p, d.parseDates &&
			(q = 0, h.pointerWidth = 0), "top" == e ? f ? h.setBounds(n + l, s + m, p + l + n, r + s) : h.setBounds(n + l, -1E3, p + l + n, s + m - q - g) : f ? h.setBounds(n, s, p + n, r + s - q) : h.setBounds(n, s + r + q + g - 1, n + p, s + r + q + g));
		this.hideCursor()
	},
	...
	zoom: function(a, b, d, e) {
		...
		var j = this.height;
		h.parseDates &&
			!h.equalSpacing ? (a = e - d + h.minDuration(), a = f ? j / a : g / a) : a = f ? j / (b - a) : g / (b - a);
		this.stepWidth = a;
		this.setPosition();
		this.hideCursor()
	},
				...
				if (d.mouseIsOver || z || C || this.forceShow)
					if (this.forceShow = !1, C) {
						...
						0 !== e && (h = {
							type: "zoomed",
							target: this
						}, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (d + e > w && (e = w - d), z + e < v && (e =
							v - z), h.start = z + e, h.end = d + e, this.fire(h.type, h)) : O + e >= this.data.length || 0 > k + e || (h.start = k + e, h.end = O + e, this.fire(h.type, h)))
					} else {
						...
						if (I && this.valueBalloonsEnabled && v && d.balloon.enabled) {
							...
							for (g = 0; g < I.length; g++)
								if (u = I[g], !(this.oneBalloonOnly && u != O) && (u.showBalloon && !u.hidden && u.balloonText) && (t = s.axes[u.valueAxis.id].graphs[u.id], w = t.y, !isNaN(w))) {
									p = t.x;
									q = !0;
									if (r) {
										if (j = w, 0 > p || p > n) q = !1
									} else if (j = p, p = w, 0 > j || j > m + h) q = !1;
									q && (q = u.valueBalloon, x = d.getBalloonColor(u, t), q.setBounds(k, l, k + m, l + n), q.pointerOrientation = "H", q.changeColor(x), void 0 !== u.balloonAlpha && (q.fillAlpha = u.balloonAlpha), void 0 !== u.balloonTextColor && (q.color = u.balloonTextColor),
										q.setPosition(j + k, p + l), u = d.formatString(u.balloonText, t, u), "" !== u && q.showBalloon(u), !r && q.set && q.set.hide(), v.push({
											yy: w,
											balloon: q
										}))
								}
		...
		if (a) {
			...
			if (this.enabled && 0 < b.length) {
				if (this.pan) this.rolledOver = !1;
					...
					d.target = this;
					d.chart = a;
					if ("cursor" == this.type) this.rotate ? this.selectionPosY = f : this.selectionPosX =
						...
						3 > Math.abs(e - h) && 3 > Math.abs(f - j) || (b = Math.min(h, e), g = Math.min(j, f), e = Math.abs(h - e), f = Math.abs(j - f), a.hideXScrollbar && (b = 0,
							e = this.width), a.hideYScrollbar && (g = 0, f = this.height), d.selectionHeight = f, d.selectionWidth = e, d.selectionY = g, d.selectionX = b, this.skipZoomDispatch || this.fire(d.type, d))
					}
					this.selectWithoutZooming || AmCharts.remove(this.selection)
				}
	...
	handleMouseDown: function(a) {
		if (this.zoomable ||
			...
			var b = this.rotate,
				...
				e = d.mouseX - this.x,
				f = d.mouseY - this.y;
			if (0 < e && e < this.width && 0 < f && f < this.height || "fake" == a) this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ? (this.drawStartY = f, this.drawStartX = e, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, d.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? f : e, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime = this.startTime, this.panClickEndTime = this.endTime) :
				this.zoomable && ("cursor" == this.type ? (this.fromIndex = this.index, b ? (this.initialMouse = f, this.selectionPosY = this.linePos) : (this.initialMouse = e, this.selectionPosX = this.linePos)) : (this.initialMouseX = e, this.initialMouseY = f, this.selectionPosX = e, this.selectionPosY = f), this.zooming = !0)
		}
	}
});
AmCharts.SimpleChartScrollbar = AmCharts.Class({
	...
	updateScrollbar: function() {
		...
		var k = j.width,
			...
			r = m.mouseY;
		a = this.initialMouse;
		m.mouseIsOver && (this.dragging && (m = this.initialCoord, l ? (a = m + (r - a), 0 > a && (a = 0), m = s - j, a > m && (a = m), h.setAttr("y", a)) : (a = m + (p - a), 0 > a && (a = 0), m = n - k, a > m && (a = m), h.setAttr("x", a))), this.resizingRight &&
		...
		if (l = a.graph) {
			...
			for (p = 0; p < d.length; p++) {
				var r = d[p].axes[s.id].graphs[l.id].values,
					q;
				for (q in r)
					if (r.hasOwnProperty(q) && "percents" != q && "total" != q) {
						var u = r[q];
						u < g && (g = u);
						u > h && (h = u)
					}
			}
			Infinity != g && (n.minimum = g); - Infinity != h &&
				(n.maximum = h + 0.1 * (h - g));
...
AmCharts.wedge = function(a, b, d, e, f, g, h, j, k, l, m) {
	...
	e = a.set();
	var I;
	p && (r = n(10 * r), t = n(10 * t), w =
		n(10 * w), x = n(10 * x), u = n(10 * u), v = n(10 * v), y = n(10 * y), q = n(10 * q), b = n(10 * b), k = n(10 * k), d = n(10 * d), g *= 10, h *= 10, j *= 10, s *= 10, 1 > Math.abs(f) && (1 >= Math.abs(w - t) && 1 >= Math.abs(y - v)) && (I = !0));
	f = "";
	if (0 < k) {
		p ? (path = " M" + r + "," + (u + k) + " L" + t + "," + (v + k), I || (path += " A" + (b - g) + "," + (k + d - h) + "," + (b + g) + "," + (k + d + h) + "," + t + "," + (v + k) + "," + w + "," + (y + k)), path += " L" + x + "," + (q + k), 0 < j && (I || (path += " B" + (b - j) + "," + (k + d - s) + "," + (b + j) + "," + (k + d + s) + "," + x + "," + (k + q) + "," + r + "," + (k + u)))) : (path = " M" + r + "," + (u + k) + " L" + t + "," + (v + k), path += " A" + g + "," + h + ",0," + C +
			",1," + w + "," + (y + k) + " L" + x + "," + (q + k), 0 < j && (path += " A" + j + "," + s + ",0," + C + ",0," + r + "," + (u + k)));
		path += " Z";
	...
	p ? (I || (f = " A" + n(b - g) + "," + n(d - h) + "," + n(b + g) + "," + n(d + h) + "," + n(t) + "," + n(v) + "," +
		n(w) + "," + n(y)), g = " M" + n(r) + "," + n(u) + " L" + n(t) + "," + n(v) + f + " L" + n(x) + "," + n(q)) : g = " M" + r + "," + u + " L" + t + "," + v + (" A" + g + "," + h + ",0," + C + ",1," + w + "," + y) + " L" + x + "," + q;
...
AmCharts.AmPieChart = AmCharts.Class({
		...
		if (AmCharts.ifArray(b)) {
			if (0 < a.realWidth && 0 < a.realHeight) {
				...
				for (m = 0; m < b.length; m++)
					if (f = b[m], !0 !== f.hidden && 0 < f.percents) {
						...
						if (a.labelsEnabled && a.labelText && f.percents >= a.hideLabelsPercent) {
							...
							var v = a.formatString(a.labelText,
									f),
								x = f.labelColor;
							void 0 == x && (x = a.color);
	...
	arrangeLabels: function() {
		...
		for (e =
			b - 1; 0 <= e; e--) d = a[e], 2 == d.labelQuarter && !d.hidden && this.checkOverlapping(e, d, 2, !0, 0);
	...
	checkOverlapping: function(a, b, d, e, f) {
		...
		if (l) {
			if (!0 === e)
				for (h = a + 1; h < k; h++)(g = this.checkOverlappingReal(b, j[h], d)) && (h = k);
			else
				for (h = a - 1; 0 <= h; h--)(g = this.checkOverlappingReal(b, j[h], d)) && (h = 0);
	...
	parseData: function() {
		...
		if (void 0 !== b) {
			...
			for (f = 0; f < d; f++) {
				...
				var j = b[f];
				g.dataContext = j;
				g.value = Number(j[this.valueField]);
				(h = j[this.titleField]) || (h = "");
				g.title = h;
				g.pulled = AmCharts.toBoolean(j[this.pulledField], !1);
				(h = j[this.descriptionField]) || (h = "");
				g.description = h;
...
AmCharts.AmXYChart = AmCharts.Class({
	...
	updateData: function() {
		...
		for (g = 0; g < d.length; g++)
			if (h = d[g], h.data = a, h.zoom(0, b), h = h.valueField) {
				var j;
	...
	handleAxisSelfZoom: function(a) {
		if ("H" == a.valueAxis.orientation) {
			...
			this.horizontalPosition = a;
			this.widthMultiplier = b
		} else b = this.fitMultiplier(a.multiplier), a = -a.position * b, d = -(this.plotAreaHeight * b - this.plotAreaHeight), a < d && (a = d), this.verticalPosition = a, this.heightMultiplier = b;
		this.zoomChart();
		this.zoomScrollbars()
	},
	handleCursorZoom: function(a) {
...
AmCharts.VMLRenderer = AmCharts.Class({
	...
	gradient: function(a, b, d, e) {
		...
		8 === document.documentMode ?
			(a.type = b, a.angle = e) : (a.setAttribute("type", b), a.setAttribute("angle", e));
		f && (a.colors.value = f)
	},
	remove: function(a) {
