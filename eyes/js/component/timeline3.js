			...
			if (xName == 1) {
				...
				if (isfirst) {
					if (baseY == _this.defaultYear) {
						...
						_this.aL = _this.axisLength - _this.xSpace*3 - 4;
	...
	*/
	...
	p.canvasClick = function(){
		...
		function fn(ev){
			...
			if (x>=_this.limitbox.offset().left + _this.limitbox.width() - _this.xSpace*3 - 5) {
				x=_this.limitbox.offset().left + _this.limitbox.width() - _this.xSpace*3 - 5
